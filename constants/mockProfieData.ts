...
export const profileData: profileDataType = {
    ...
    about: "Frontend Developer crafting responsive, performant, and intuitive web experiences.",
    strengths: "Modern Frontend Architecture and Full-Cycle Development & Leadershipand Form Validation",
    need_improve: "Advanced Backend Architecture and DevOps & Automation Pipelines",
    activity: null,
    education: [
        { id: 0, school: "Al A;azhar Univercity", degree: 78.8, study_field: "biomedical Engeneer", start_at: "jan 2016", end_at: "jan 2022", description: "Focused on medical device technology, healthcare software applications, and biomedical engineering principles.", media_url: "/////", image_url: "////" }
    ],
    profile_language: "en",
    certificate: [
