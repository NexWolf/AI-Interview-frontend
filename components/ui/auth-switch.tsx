...
export default function AuthSwitch({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, oklch(93% 0.05 295) 0%, oklch(86% 0.09 300) 55%, oklch(78% 0.13 305) 100%)",
      }}
    >
      <style>{`
        :root {
          ...
          --muted-foreground: oklch(52% 0.04 295);
          --card: oklch(100% 0 0);
      ...
      >
        ...
        {/* الفورمات */}
        <div
          className="absolute top-1/2 grid w-[380px]"
          style={{
            left: isSigninActive ? "75%" : "25%",
        ...
        >
          <div
            className="flex flex-col items-center justify-center px-10 md:px-14"
            style={{
              gridColumn: "1 / 2",
              gridRow: "1 / 2",
        ...
        <div className="absolute inset-0 grid grid-cols-2">
          <div
            ...
            style={{ alignItems: "flex-end", padding: "3rem 16% 2rem 10%", zIndex: 6, pointerEvents: isSigninActive ? "auto" : "none" }}
          >
            <div
            ...
            >
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.35em] text-white/80">{brandLabel}</p>
              <h3 className="mb-3 font-display text-3xl font-semibold text-white">New here?</h3>
              ...
              <button
                ...
                className="rounded-full border-2 border-white px-8 py-2.5 text-sm font-semibold tracking-wide text-white transition-colors hover:bg-white hover:text-[var(--primary)]"
              >
                SIGN UP
              </button>
            </div>
          ...
          <div
            className="flex flex-col justify-center text-center"
            style={{ alignItems: "flex-start", padding: "3rem 10% 2rem 16%", zIndex: 6, pointerEvents: isSigninActive ? "none" : "auto" }}
          >
            <div
              className="text-white"
              style={{
            ...
            >
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.35em] text-white/80">{brandLabel}</p>
              <h3 className="mb-3 font-display text-3xl font-semibold text-white">One of us?</h3>
              <p className="mb-6 text-sm leading-relaxed text-white/90">
